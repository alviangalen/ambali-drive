    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-sm p-6 text-center border border-gray-100">
          ...
          <h2 className="text-xl font-semibold mb-2 text-gray-900">Protected File</h2>
          <p className="text-gray-500 text-sm mb-6">This file is password protected. Please enter the password to view it.</p>
          <form onSubmit={e => { e.preventDefault(); fetchFile(password); }}>
            <input
              ...
              className="w-full px-4 py-2 border border-gray-200 rounded-xl mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
            />
    ...
    <div className="min-h-screen flex flex-col bg-gray-950">
      <header className="h-16 border-b border-white/10 flex items-center justify-between px-6 bg-gray-900/50 backdrop-blur-md">
        ...
        {allowDownload && file.type !== 'folder' && (
          <button onClick={handleDownload} className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl transition-colors text-sm font-medium">
