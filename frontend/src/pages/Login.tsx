    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden slide-up">
        <div className="px-8 pt-8 pb-6 text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Sign in to your Ambali Drive account</p>
        </div>
        ...
        <div className="px-8 pb-8 space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-70"
          >
